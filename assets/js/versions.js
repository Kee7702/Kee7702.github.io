(async () => {
  const res = await fetch(`/app/mcversion.json`);
...
version++
      ...
      var versioncodes = document.createElement('a');
      versioncodes.textContent = "Version Codes"
      versioncodes.style = "display:block;font-size:18px;line-height:22px"
      versionname.appendChild(versioncodes);
if (versionlist[version].codes['armeabi-v7a']) {
      var versioncodearmeabiv7a = document.createElement('a');
      versioncodearmeabiv7a.textContent = ("armeabi-v7a: " + versionlist[version].codes['armeabi-v7a'])
      versioncodearmeabiv7a.style = "display:block;font-size:14px;font-weight:100;line-height:18px"
      versionname.appendChild(versioncodearmeabiv7a);
}else {}
if (versionlist[version].codes['x86']) {
      var versioncodex86 = document.createElement('a');
      versioncodex86.textContent = ("x86: " + versionlist[version].codes['x86'])
      versioncodex86.style = "display:block;font-size:14px;font-weight:100;line-height:18px"
      versionname.appendChild(versioncodex86);
}else {}
if (versionlist[version].codes['arm64-v8a']) {
      var versioncodearm64v8a = document.createElement('a');
      versioncodearm64v8a.textContent = ("arm64-v8a: " + versionlist[version].codes['arm64-v8a'])
      versioncodearm64v8a.style = "display:block;font-size:14px;font-weight:100;line-height:18px"
      versionname.appendChild(versioncodearm64v8a);
}else {}
if (versionlist[version].codes['x86_64']) {
      var versioncodex8664 = document.createElement('a');
      versioncodex8664.textContent = ("x86_64: " + versionlist[version].codes['x86_64'])
      versioncodex8664.style = "display:block;font-size:14px;font-weight:100;line-height:18px"
      versionname.appendChild(versioncodex8664);
}else {}
